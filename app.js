const q=[
  ['开麦、对抗与弱者道',['那个比赛有什么用，招笑','游戏和人生的区别是什么，这个（无限月读）和游戏的区别就是什么','我 all-in 啊','中国人能古法','是的，我也不怕和你们这些人打','sayless','闹麻了','因为我要弱者道','明知故问，弱者道，就像我问 zake 公司是不是在优盛大厦','不行不行，我得冷静，我刚准备周四坐火车去南京了，后来想还是没必要，等我有能力了线下真实他','来吧，开始今天的访谈','我每天都在录音里给自己打气','我不想输，我要赢','刻意避开正确答案']],
  ['AI、工作与创业',['你们说我们公司会不会被腾讯收购','我想享受音乐，（会议）拜拜','原来我可以瞥见下班的日光','每次面试都是心理折磨','我不做 AI 就都别做 AI 了','我就是AI本身','写给 agent 看的你就放GitHub仓库里，放飞书的就是给人看的','我们不用思考这个问题，因为三年后大家都不用上班了','我的 Dia 现在开始每天会为我写一份 brief，一副艺术画、自动为我整理的 todo，并通知我 deepseek 发了新模型','怎么做咕咕嘎嘎机器人的同时，规避字节版权的风险','我会监督 Reina','我要创业卖咕咕嘎嘎机器人','我现在是 Vidmuse 产品组最古法之人，仅次于扎克','基于开源模型挂个 lora 就是 neo lab ai research 了','小微并没有提醒我','我梦到我智谱老板是 gay','他还问我们公司怎么存活？我说我们 Founder 也在想这个问题呀。']],
  ['冕爹、课堂与宣言',['生科楼，这是差专业！','你不是喜欢化学，你是喜欢做化学题','我们学校大部分人都不知道陈冕，绝大部分人，这些人都是傻子','我冕爹是中国 AIGC 第一人，你们这些都迟早会被他收购','666 敢质疑我冕爹，跟他爆了呀','冕爹能不能吃字节']],
  ['纯粹、吃喝与目的地',['我想去拼多多仓库，听说那里很纯粹','如果有饭可以带我吃，我住得近','入口顺滑 初咽是绿茶 赤藓糖醇微微甘甜 回味是淡淡的茉莉花香','它的赤藓糖醇加的比较克制，不像元气森林，当然我很喜欢元气森林','喝水你喝太多你会很胀，可能都不想喝了，但是喝酒不会','你这有厕所吗，我很急，我可以在你这买瓶饮料']],
...
let im=null;
function loadPlayerAsset(){if(im)return;
let source=new Image;
source.onload=()=>{let c=document.createElement('canvas');
c.width=source.width;
c.height=source.height;
let a=c.getContext('2d');
a.drawImage(source,0,0);
...
im=c};
source.src='assets/mario-player.jpg'}
